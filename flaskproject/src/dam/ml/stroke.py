...
class StrokeService:
    def __init__(self):
        self.stroke = pd.read_csv('../../../flaskproject/static/data/dam/ml/data/healthcare-dataset-stroke-data.csv')
        self.my_stroke = None
    ...
    '''
    def target(self):
        df = pd.read_csv('../../../flaskproject/static/data/dam/ml/save/stroke.csv')
