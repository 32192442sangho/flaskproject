...
class Crime:
    ...
    def __init__(self):
        self.crime = pd.read_csv('../../../static/data/dam/ml/data/crime_in_seoul.csv')
        cols = ['절도 발생','절도 검거','폭력 발생', '폭력 검거']
        self.crime[cols] = self.crime[cols].replace(',', '', regex=True).astype(int)  # regex=True
        self.cctv = pd.read_csv('../../../static/data/dam/ml/data/cctv_in_seoul.csv')
        self.pop = pd.read_excel('C:/Users/gpark/PycharmProjects/flaskProject/static/data/dam/ml/data/pop_in_seoul.xls',usecols=["자치구","합계","한국인","등록외국인","65세이상고령자"], skiprows=[0,2])
        ...
        self.us_unemployment = pd.read_csv('../../../static/data/dam/ml/data/us_unemployment.csv')
    ...
    def save_police_pos(self): # 2
        ...
        print(pd.read_pickle('../../../static/data/dam/ml/save/police_pos.pkl'))
    ...
    def save_cctv_pop(self): # 3
        ...
        print(pd.read_pickle('../../../static/data/dam/ml/save/cctv_pop.pkl'))

    def save_police_norm(self): # 4
        police_pos = pd.read_pickle('../../../static/data/dam/ml/save/police_pos.pkl')
        ...
        print(pd.read_pickle('../../../static/data/dam/ml/save/police_norm.pkl'))
    ...
    def save_us_unemployment_map(self): # 5
        ...
        mc.location = [48, -102]
        mc.zoom_start = 5
        mc.save_path = "../../../static/data/dam/ml/save/unemployment.html"
    ...
    def save_seoul_crime_map(self): # 6
        ...
        mc.zoom_start = 12
        mc.save_path = "../../../static/data/dam/ml/save/seoul_crime_rate.html"
        MyChoroplethService(mc)

    def get_seoul_crime_data(self):
        police_pos = pd.read_pickle('../../../static/data/dam/ml/save/police_pos.pkl')
        police_norm = pd.read_pickle('../../../static/data/dam/ml/save/police_norm.pkl')
